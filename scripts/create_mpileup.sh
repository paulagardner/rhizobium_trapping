...
samtools mpileup -b ~/Fudge016/TrappingCh2/rhizobium_trapping/data/sorted_bam_files.txt -f   -o ~/Fudge016/TrappingCh2/rhizobium_trapping/data/documentation-test.mpileup
